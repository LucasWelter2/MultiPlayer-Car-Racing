class Game {
  ...
  start() {
    ...
    var obstacle1Positions = [
      ...
      { x: width / 2 - 150, y: height - 5600, image: obstacle1Image },
      { x: width / 2 + 250, y: height - 5900, image: obstacle1Image },
      { x: width / 2 - 180, y: height - 6200, image: obstacle1Image },
     
      { x: width / 2 - 150, y: height - 6500, image: obstacle1Image },
      { x: width / 2, y: height - 6800, image: obstacle1Image },
    ...
    this.addSprites(powerCoins, 36, powerCoinImage, 0.09);
  ...
  play() {
    ...
    if (allPlayers !== undefined) {
      image(track, 0, -height * 10, width, height * 12);
